...
REM Copy files to output folders.
for /f "delims=|" %%f in ('dir /b "Source\*.glsl"') do (
	copy Source\%%f ..\..\Release\shaders\%%f 1>NUL
	copy Source\%%f ..\..\Debug\shaders\%%f 1>NUL
	copy Source\%%f ..\..\x64\Release\shaders\%%f 1>NUL
	copy Source\%%f ..\..\x64\Debug\shaders\%%f 1>NUL
)
